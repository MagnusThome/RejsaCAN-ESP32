...
- On RejsaCAN v2.x - NON S3 ESP32 - the engine rpms are continously printed over the Bluetooth connection
...
#define ESP32S3   // COMMENT THIS OUT FOR RejsaCAN 2.x NON S3 ESP32 BOARDS
